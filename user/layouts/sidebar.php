    ...
    <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
      <div class="flex-1 px-3 space-y-1 bg-white divide-y">
        <ul class="pb-2 space-y-2">
          <li>
            <a href="../view/dashboard.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 group <?= ($data['title'] == 'User Dashboard') ? 'bg-gray-100' : ''; ?>">
              <svg class="w-6 h-6 transition duration-75 group-hover:text-gray-900 <?= ($data['title'] == 'User Dashboard') ? 'text-gray-900' : 'text-gray-500'; ?>" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
