<div id="main-content" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64">
  <main>
    <div class="p-3">
      <h1 class="mb-4 text-2xl font-bold leading-none text-gray-900 sm:text-3xl">Welcome, <?= $_SESSION['fname']; ?>!</h1>
      <div class="grid w-full grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-3">
        <?php
        foreach ($userCount as $data) {
          $description = 'Number of Users';
          $svg = '<svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>';
          include 'card.php';
        }
        foreach ($activityCount as $data) {
