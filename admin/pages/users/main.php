    ...
    <main>
          ...
          <div class="sm:flex">
            ...
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
              ...
              <form action="../includes/export.inc.php" method="POST" enctype="multipart/form-data">
                <button type="submit" name="export" class="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 sm:w-auto">Export</button>
      ...
      if (!empty($records)) {
        if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
          $query = $_GET['search'];
          $records = $user->getUserSearchData($query);
