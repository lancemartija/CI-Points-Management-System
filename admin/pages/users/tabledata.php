              ...
              <tr class="hover:bg-gray-100">
                ...
                <td class="p-4 space-x-2 whitespace-nowrap">
                  <button type="button" data-view-button data-fname="<?= $data['first_name']; ?>" data-mname="<?= $data['middle_name']; ?>" data-lname="<?= $data['last_name']; ?>" data-address="<?= $data['address']; ?>" data-email="<?= $data['email']; ?>" data-contact="<?= $data['contact_number']; ?>" data-department="<?= $data['department']; ?>" data-division="<?= $data['division']; ?>" data-status="<?= $data['status']; ?>" data-type="<?= $data['type']; ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-600 rounded-lg hover:bg-gray-700 focus:ring-4 focus:ring-gray-200">
                    ...
                    View
                  </button><button type="button" data-edit-button data-id="<?= $data['user_id']; ?>" data-fname="<?= $data['first_name']; ?>" data-mname="<?= $data['middle_name']; ?>" data-lname="<?= $data['last_name']; ?>" data-address="<?= $data['address']; ?>" data-email="<?= $data['email']; ?>" data-contact="<?= $data['contact_number']; ?>" data-department="<?= $data['department']; ?>" data-division="<?= $data['division']; ?>" data-status="<?= $data['status']; ?>" data-type="<?= $data['type']; ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200">
