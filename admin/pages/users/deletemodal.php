<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto bg-gray-900/50 top-4 md:inset-0 h-modal sm:h-full" id="deleteusermodal" aria-modal="true" role="dialog">
  <div class="relative w-full h-full max-w-md px-4 md:h-auto">
    <div class="relative bg-white rounded-lg shadow">
      ...
      <div class="p-6 pt-0 text-center">
        ...
        <h3 class="mt-5 mb-6 text-xl font-normal text-gray-500">Are you sure you want to proceed?</h3>
        <form action="../includes/users.inc.php" method="post">
          <input id="id" type="hidden" name="id" value="<?= $data['user_id']; ?>" readonly>
