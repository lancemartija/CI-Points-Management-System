        ...
        <div class="p-6 space-y-6">
          <div class="grid grid-cols-9 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <select name="year" class="bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none sm:text-sm rounded-lg focus:ring-gray-200 focus:ring-4 block w-full p-2.5" required>
