    ...
    <main>
      ...
      <div class="items-center justify-between block p-4 bg-white border-b border-gray-200 sm:flex">
        <div class="w-full mb-1">
          <div class="mb-4">
              ...
              <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li>
                  <div class="flex items-center">
                    ...
                    <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">CI Activities</a>
                  </div>
                </li>
                <li>
                  <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">All activities</h1>
          </div>
          <div class="sm:flex">
            <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
              <form class="flex lg:pr-2" action="#" method="get">
                ...
                <div class="relative mr-2 lg:w-64 xl:w-96">
                  <input type="text" name="search" class="bg-gray-50 border border-gray-300 text-gray-900 focus:outline-none sm:text-sm rounded-lg focus:ring-gray-200 focus:ring-4 block w-full p-2.5" placeholder="Search for activities" required>
                </div>
              ...
              <div class="flex pl-0 mt-3 space-x-1 sm:pl-2 sm:mt-0">
                <a href="ciactivities.php" class="text-gray-900 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 border border-gray-200 font-medium inline-flex items-center rounded-lg text-base px-3 py-2 text-center;">
      ...
      if (!empty($records)) {
        if (isset($_GET['search']) && !empty(trim($_GET['search']))) {
          $query = $_GET['search'];
          $records = $activity->getActivitySearchData($query);
        ...
        include_once '../pages/ciactivity/deletemodal.php';
      }
      ?>
    </main>
  </div>
