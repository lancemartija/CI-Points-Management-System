<div class="flex flex-wrap m-6 space-x-4">
      ...
      <div class="inline-block min-w-full align-middle">
        <div class="overflow-hidden shadow">
          <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg">
            ...
            <p class="mb-3 font-normal text-gray-700">Has <span class="font-bold"><?= $data['COUNT(ur.activity_id)']; ?></span> pending request(s).</p>
