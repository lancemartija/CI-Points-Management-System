      ...
      <div class="p-6 space-y-8 sm:p-8 lg:p-16">
        ...
        <form class="mt-8 space-y-6" action="includes/login.inc.php" method="post">
          <div>
            ...
            <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="name@dlsl.edu.ph" required>
          </div>
          <div>
          ...
          <button type="submit" name="submit" class="w-full px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 sm:w-auto">Login to your account</button>
          <div class="text-sm font-medium text-gray-500">
            <div>Not an admin? <a href="../" class="text-teal-500 hover:underline">Selection Menu</a></div>
          </div>
        </form>
      </div>
    </div>
